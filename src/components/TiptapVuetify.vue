...
import MathBlock from '~/extensions/mathest'
// import { renderMathInDocument } from 'mathlive'
// import insertHTML from '~/extensions/custom/insertHtml'
...
export default class TiptapVuetify extends Vue {
  ...
  mounted () {
    ...
    this.editor = (new Editor({
      ...
      editorProps: {
        ...
        handleMath: (view, event) => { 
          console.log('TODO HANDLE MATH', event)
        }
      },
  ...
  onUpdate (info) {
    ...
    console.log('ON CHANGE DU STRKC')
